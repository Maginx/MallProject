...
namespace MallHost
{
    ...
    internal sealed class MallProxy : IMallProxy
    {
        ...
        {
            return Global.DBProcess.UpdateTracData(endoscop, wareNo, doctorName, patientNO, patientName, nurseNO, patientId);
        }
        ...
        {
            return Global.DBProcess.EndoscopeIsQuality(en);
        }
    }
}
