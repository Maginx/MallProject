...
namespace ProxyClient.Controls
{
    ...
    internal sealed partial class DataTrace : KryptonForm
    {
        ...
        public DataTrace()
        {
            ...
            for (int i = 0; i < this.dataGridViewTrace.Columns.Count; i++)
            {
                this.dataGridViewTrace.Columns[i].SortMode = DataGridViewColumnSortMode.Programmatic;
            }
        }
        ...
        private void dataGridViewTrace_ColumnHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
        }
    }
}
