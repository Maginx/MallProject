...
namespace ProxyClient.Steps
{
    ...
    internal class Wash
    {
        ...
        public void PrintTempRecordMsg(string msg, Color color)
        {
            ...
            FormHelper.AppendText(msg, Color.Green);
            //GSetting.GetFormInstance<TempRecord>().richTxtTempRecord.Invoke(FormHelper.RichTextBoxMethod, msg, Color.Green);
        }
        ...
        public void ShowStatusTips(string msg, Color color)
        {
            ...
            GSetting.GetFormInstance<MainForm>().statusStripTips.Invoke(FormHelper.TextBoxMethod, msg, color);
            this.PrintTempRecordMsg(this.EndoscopeSN + msg, color);
        }
